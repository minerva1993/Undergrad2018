...
#ifdef makeTuple_cxx
makeTuple::makeTuple(TTree *tree) : fChain(0) 
{
...
Int_t makeTuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeTuple::LoadTree(Long64_t entry)
{
...
void makeTuple::Show(Long64_t entry)
{
...
Int_t makeTuple::Cut(Long64_t entry)
{
